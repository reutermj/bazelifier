...
const CATALOG_DEFINES: &[&str] = &[
    ...
    // are probed rather than left undefined. Paths in the catalog were
    // harvested from each project's `configure`, never guessed from these
    // names (the reverse mapping is ambiguous).
    ...
    "SIZEOF_SIZE_T",
    "SIZEOF_SSIZE_T",
    // libevent 2.1.12 (bzl-7r9.3): header, function, type-presence and
    // size facts from its configure. See the catalog's own notes.
    "HAVE_ACCEPT4",
    "HAVE_AFUNIX_H",
    ...
    "HAVE_GETADDRINFO",
    "SIZEOF_PTHREAD_T",
    // hwloc 2.7.1 (bzl-7r9.4): header, function, declaration, type-presence
    // and size facts from its configure. See the catalog's own notes.
    "HAVE_CLZ",
    "HAVE_CLZL",
    "HAVE_CL_CL_EXT_H",
    ...
    "HAVE_KSTAT_H",
    "HAVE_LANGINFO_H",
    "HAVE_LEVEL_ZERO_ZES_API_H",
    "HAVE_LEVEL_ZERO_ZE_API_H",
    "HAVE_LIBUDEV_H",
    "HAVE_MACH_INIT_H",
    "HAVE_MACH_MACH_HOST_H",
    ...
    "HAVE_MPI_H",
    "HAVE_NL_LANGINFO",
    "HAVE_NVCTRL_NVCTRL_H",
    "HAVE_NVML_H",
    "HAVE_OPENAT",
    "HAVE_OPENCL_CL_EXT_H",
    "HAVE_PICL_H",
    "HAVE_POSIX_MEMALIGN",
    "HAVE_PTHREAD_T",
    "HAVE_PUTWC",
    "HAVE_ROCM_SMI_ROCM_SMI_H",
    "HAVE_SSIZE_T",
    "HAVE_STRFTIME",
    "HAVE_SYS_DOMAINSET_H",
    "HAVE_SYS_LGRP_USER_H",
    "HAVE_SYS_THR_H",
    "HAVE_SYS_UTSNAME_H",
    "HAVE_UNAME",
